      ...
      <el-table :data="MyTask" height="600" border style="width:100%">
       ...
       <el-table-column label="操作" width="120">
        <template scope="scope">
           <el-button @click.native.prevent="Detail(scope.$index,MyTask)" type="text" size="small"> 查看详情 </el-button>
        </template>
      </el-table-column>
     </el-table>
    </el-col>
...
export default{
  ...
  mounted(){
   ...
   //Axios.get('http://39.108.181.155:8009/Stu/MyTask?name='+this.$store.state.username)
   .then(function(res){
       //成功获取json数据信息的话
